            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card shadow-lg border-0 rounded-4" style="max-width: 450px; width: 100%; background: #ffffff; padding: 20px;">
                        <h3 class="card-header text-center text-white py-3 rounded-top" style="background: linear-gradient(90deg, #007bff, #6610f2); font-size: 1.5rem;">Create User</h3>
                        <div class="card-body p-4">
                            <form action="{{ route('user.postUser') }}" method="POST">
                                @csrf
                                <div class="form-group mb-3">
                                    <label for="name" class="form-label" style="font-weight: 600;">Name</label>
                                    <input type="text" placeholder="Enter your name" id="name" class="form-control rounded-pill" name="name" required autofocus>
                                    @if ($errors->has('name'))
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary rounded-pill" style="font-size: 1rem; font-weight: 600; background: linear-gradient(90deg, #007bff, #6610f2); border: none;">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
